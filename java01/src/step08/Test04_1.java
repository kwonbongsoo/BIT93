 ...
 *          ex) Object obj = new Integer(20);
 *      - 산술 연산자나 관계 연산자, 비트 논리 연산자, 논리 연산자, 비트 이동 연산자,
...
public class Test04_1 /* extends Object */{
  ...
  public static void main(String[] args) {
   ...
   int x = obj.intValue();
   // 인스턴스에서 int 값을 뽑아내는 기능.
   System.out.println(x);
   String str = obj.toString();
   // 인스턴스에서 정수 값을 문자열로 뽑아내는 기능
   ...
   System.out.println(obj.compareTo(new Integer(5)));  // 아규먼트의 값보다 크면 양수
   System.out.println(obj.compareTo(new Integer(10))); // 아규먼트의 값과 같으면 0
   System.out.println(obj.compareTo(new Integer(20))); //  아규먼트의 값보다 작으면 음수
