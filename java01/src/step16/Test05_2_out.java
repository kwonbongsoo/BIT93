 ...
 * => 객체 출력하기!
 * => 직렬화(Serializeble = marshaling)
 *      인스턴스 -----> 바이트 배열
 * => 객체로 복원(Deserializeble = marshalin)
 *      바이트 배열 ----> 인스턴스
 * => 주의!
 *      직렬화가 가능한 클래스는 java.io.Serializeble 규격을 따르는 클래스이다.
...
public class Test05_2_out {
  public static void main(String[] args) throws IOException {
    ...
    // 바로 출력할 수 없다.
    // 물론, 개ㅑㄱ체의 인스턴스 변수의 값을 하나씩 꺼내서 출력하는 것은 가능하다.
//    Student s = new Student("홍길동", 100, 90, 80, false);
    
    // Student2 클래스는 직렬화 허락하고 있다.
    // => java.io.Serializable의 규약(=규격=규칙)을 따르고 있다.
