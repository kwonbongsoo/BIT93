/* 인터페이스1
 * => 인터페이스는 호출 규칙을 정의하는 것이기 때문에 추상 메서드만 선언가능 하다.
 *      즉 인터페이스에 선언된 모든 메서드는 public이고 abastract 이다.
...
public interface A {
  // 1) 규칙이기 때문에 무조건 공개 메서드이고, 추상 메서드 이다.
  public abstract void m1 ();
  
  // 2)public을 생략해도 내부적으로 public 으로 간주한다.
  abstract void m2();
...
//  void m4() {} //컴파일 오류
 ...
 // 3) static 을 생략하면 내부적으로 static 으로 간주한다.
  final int v3 = 200;
