 ...
 * => 보통 클래스를 딱 한 번만 사용할 경우
 * => 익명 클래스 만드는 문법
 *      1) 참조변수 선언 = new 수퍼클래스이름(수퍼 클래스 생성자호출 파라미터) { . . . }
 *      2) 참조변수 선언 = new 인터페이스이름( 수퍼 클래스 생성자호출 파라미터) { . . . }
 */
package step13;
...
public class Test05_1 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    Object obj = new Object() {
      ...
      // 그러나 인스턴스 블록은 가능하다.
      // 그래서 익명 클래스의 인스턴스 변수 값을 초기화 시킬 때 
      // 인스턴스 블록을 사용한다.
      {
