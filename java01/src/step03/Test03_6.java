...
public class Test03_6 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(a >> 1); // => 0000_0101|1 짤림 a / 2^1
    System.out.println(a >> 2); // => 0000_0010|11 짤림 a / 2^2
    System.out.println(a >> 3); // => 0000_0001|011 짤림 a / 2^3
    
    // >>> 연산자 : 빈자리를 무조건 0으로 채운다.
    System.out.println(-10 >> 2); //음수
    System.out.println(-10 >>> 2);//양수
    
    //<< 연사자 : 오른쪽 빈자리를 무조건 0으로 채운다.
    // <<< 연산자는 없다.
    System.out.println(a);
