 ...
 *      - 즉 객체 생성 과정이 복잡한 경우 사용하는 설계 비법이 "펙토리 메서드" 패턴이다
 */
package step27.ex3;
...
public class Test05 {
  public static void main(String[] args) {
   // 5) Spring IoC 컨테이너를 사용하여 팩토리 메서드 사용하기
   // => 스프링에서 제공하는 규칙에 따라 팩토리 메서드를 만든다.
    
    ApplicationContext ctx = 
        new ClassPathXmlApplicationContext("step27/ex3/application-context-05.xml");
