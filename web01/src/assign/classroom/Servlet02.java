...
@WebServlet(urlPatterns="/assign/classroom/Servlet02")
public class Servlet02 extends GenericServlet{
  ...
  public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
    ...
    try {
      ...
      List<ClassRoom> list = croomDao.selectList(pageNo, pageSize);
      
      out.println("<a href='form.html'>강의실</a>");
      out.println("<table border='1'>");
      out.println("<thead>");
      out.println("<tr><th>번호</th><th>강의실</th></th>");
      out.println("</thead>");
      out.println("<tbody>");
