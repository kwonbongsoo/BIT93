...
public class LoginServlet extends HttpServlet{
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    out.println("<input type='checkbox' name='saveEmail'> 이메일 저장하기 ");
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    String password = req.getParameter("password");
      ...
      try {
        assign.lecture.dao.MemberDao memberDao = (assign.lecture.dao.MemberDao)this.getServletContext().getAttribute("memberDao");
        ...
        if (member != null) { //로그인 성공
          ...
          //HttpSession 보관소에 로그인 회원 정보를 저장
          session.setAttribute("loginMember", member);
           ...
           res.sendRedirect("../lecture/Servlet02");
        } else {
