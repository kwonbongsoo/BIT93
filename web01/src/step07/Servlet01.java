/* 서블릿 끼리 값을 공유하는 방법: ServletContext 보관소 사용하기
...
public class Servlet01 extends HttpServlet{
  ...
  public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    ServletContext sc = this.getServletContext(); // HttpServlet 클래스로부터 상속 받은 메서드로부터 받을수잇다
    sc.setAttribute("v1", "hi");
    
      RequestDispatcher rd = req.getRequestDispatcher("/step07/Servlet02");
      rd.forward(req, res);
