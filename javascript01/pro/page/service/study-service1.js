...
module.exports = {
  ...
  search(pageNo, pageSize, searchValue, type, success, error) {
    var obj = this
    this.studyDao.search(pageNo, pageSize,searchValue, type, function(studies) {
      obj.studyDao.searchCountAll(searchValue, type, function(result) {
        success(studies, result[0].cnt)
      }, error)
    }, error)
  },//list()
