...
console.log('str1의 2번방 문자', str1.charAt(2))
// - 다음은 위의 명령문과 비슷하다
// String() 인스턴스 함수를 사용해보자!
console.log('문자열 길이 str1 = ', str1.length)
console.log('----------------------------')
var str2 = 'Hello' //문자열을 값으로 표현한다.
console.log(str2)
console.log(typeof(str2))
console.log('str2의 길이 = ', str2.length)
console.log('str2의 2번방 문자', str1.charAt(2))
// - str2 는 객체가 아니라 단순히 문자열 값이다
// 그런데 String()에서 제공하는 함수를 인스턴스 함수를 사용하는 순간
// 즉시 String 객체로 전환된다.
// 따라서 new String()으로 초기화 시킨 str1처럼 사용할 수 있다.
