function bit(value) {
  ...
  el.attr = function(name, value) {
    ...
    if(arguments.length < 2) { // 특정 이름을 가진 속성의 값을 꺼낸
    ...
    return this[0].getAttribute(name)
    /* etAttribute() 은 해당 요소에 지정된 값을 반환 합니다.
    만약 주어진 속성이 존재 하지 않는 다면, null 값이나 ""(빈문자열);
    을 반환 할 것입니다. 'data-no' 의 값을 반환
    */
  }
