...
// 1)변수 선언 시 값을 초기화 시키는 다양한 방법


//각 변수 선언 마다 값 초기화 시키기
var a = 10
var b = 20
var c = 30
console.log(a, b, c)
// 2) 한 번에 여러 개의 변수를 선언하고 초기화 시키기
var i = 10, j = 20, k = 30

// 3) 배열의 값을 한번에 여러 변수에 할당하는 방법
console.log(i, j, k)
var [x, y, z] = [10, 20 ,30, 40, 50]

console.log(x, y, z)

// 4) 객체에 특정 프로퍼티의 값들을 한 번에 변수에 저장하는 방법
...
//이렇게 사용하려면 객체의 프로퍼티(변수)명이 같아야한다.
